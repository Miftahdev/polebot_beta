...
echo_and_run cd "/home/miftah/polebot_beta/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/miftah/polebot_beta/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/miftah/polebot_beta/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \

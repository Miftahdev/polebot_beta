...
echo_and_run cd "/home/miftah/polebot_beta/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/miftah/polebot_beta/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/miftah/polebot_beta/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \

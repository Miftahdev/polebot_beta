...
echo_and_run cd "/home/miftah/polebot_beta/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/miftah/polebot_beta/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/miftah/polebot_beta/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
